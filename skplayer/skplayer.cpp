	...
	: QWidget(parent), VideoWidth(0), VideoHeight(0)
{
	...
	connect(ui.ProtoButton, SIGNAL(clicked()), this, SLOT(SetProtoFile()));
...
void skplayer::openFile(QString name)
{
	...
	SplitVideo::Get2()->OpenSource(name.toStdString());
